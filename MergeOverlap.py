...
if __name__ == '__main__':
    ...
    if args.processes:
        ...
        for gene in file_inputs:
            ...
            arguments.append((gene,clean_path,aa_path,nt_path,args.comparison,args.debug,args.majority,args.majority_count, ))
        ...
        for gene in file_inputs:
            ...
            nt_gene = make_nt_name(gene)
            nt_path = os.path.join(nt_input,nt_gene)
            main(gene,clean_path,aa_path,nt_path,args.comparison,args.debug,args.majority,args.majority_count)
