...
def main(argv):
    ...
    for taxa in taxas:
        ...
        case_b = taxa_name[-1].isnumeric() and taxa_name[-2] == 'R' and taxa_name[-3] == '_'
        case_c = not taxa_name[-1].isnumeric() and taxa_name[-2].isnumeric() and taxa_name[-3] == 'R' and taxa_name[-4] == '_'
